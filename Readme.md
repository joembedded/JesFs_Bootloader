...
___New Release V2.xx soon (New Features: available for more CPUs (nRF52832,nRF52833,nRF52840), no need for JesFs for smaller Firmware Updates, easy-2-use Javascript/HTML libraries, ...)___
